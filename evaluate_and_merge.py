"""
SAM Variant Benchmark Framework

This script benchmarks multiple SAM-family variants for prompt-guided
nanoparticle segmentation using a fixed reference image.
...
Main features
-------------
- Prompt-flow segmentation benchmarking
- Box-only segmentation evaluation
- Variant-wise metric aggregation
- Difference-map generation
- Visualization montage export

The framework compares segmentation performance across different
SAM-family foundation models under a unified prompt setting.
"""
...
MASK_ROOT = "path/to/output/masks"
DIFF_ROOT = "path/to/output/difference"

# Temporary output directory
TEMP_ROOT = "path/to/output/tmp"

# SAM-family benchmark variants
MODEL_VARIANTS = [
    {
        "model_name": "microsam",
        "display_name": "MicroSAM",
        "model_tag": "microsam_vit_b",
        "sam_checkpoint": "path/to/checkpoints/microsam_vit_b.pth",
        "model_type": "vit_b",
    ...
    },
    {
        ...
        "sam_checkpoint": "path/to/checkpoints/medsam_vit_b.pth",
        "model_type": "vit_b",
...
# ----------------------------------------
MONTAGE_1_COLS = 4
MONTAGE_1_ROWS = 5   # First montage grid
